...
Several other models have been trained and tested, apart from the final Random Forest, which can be found in the prediction_models.ipynb file or individually in the various .ipynb files present in the code/models/ directory. 
